...
```bash
git remote add encore encore://angelsense-admin-portal-mq22
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/angelsense-admin-portal-mq22/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/angelsense-admin-portal-mq22/settings/integrations/github)
