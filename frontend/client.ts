...
export class Client {
    ...
    public readonly proxy: proxy.ServiceClient
    ...
    constructor(target: BaseURL, options?: ClientOptions) {
        ...
        this.proxy = new proxy.ServiceClient(base)
    }
 ...
 */
import {
    getCustomer as api_proxy_customers_getCustomer,
    listCustomers as api_proxy_customers_listCustomers
} from "~backend/proxy/customers";
import {
...
import {
    ...
    updateTicket as api_proxy_tickets_updateTicket
} from "~backend/proxy/tickets";
...
export namespace proxy {
    ...
    export class ServiceClient {
         ...
         */
        public async getCustomer(params: { id: string }): Promise<ResponseType<typeof api_proxy_customers_getCustomer>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/customers/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_customers_getCustomer>
        }

        /**
         * Retrieves a specific device by ID.
         */
        public async getDevice(params: { id: string }): Promise<ResponseType<typeof api_proxy_devices_getDevice>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/devices/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_devices_getDevice>
        }

        /**
         * Retrieves a specific support ticket by ID.
         */
        public async getTicket(params: { id: string }): Promise<ResponseType<typeof api_proxy_tickets_getTicket>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/tickets/${encodeURIComponent(params.id)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_tickets_getTicket>
        }

        /**
         * Retrieves all customers with optional filtering and pagination.
         */
        public async listCustomers(params: RequestType<typeof api_proxy_customers_listCustomers>): Promise<ResponseType<typeof api_proxy_customers_listCustomers>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_customers_listCustomers>
        }

        /**
         * Retrieves all devices with optional filtering and pagination.
         */
        public async listDevices(params: RequestType<typeof api_proxy_devices_listDevices>): Promise<ResponseType<typeof api_proxy_devices_listDevices>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/devices`, {query, method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_devices_listDevices>
        }

        /**
         * Retrieves all support tickets with optional filtering and pagination.
         */
        public async listTickets(params: RequestType<typeof api_proxy_tickets_listTickets>): Promise<ResponseType<typeof api_proxy_tickets_listTickets>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_tickets_listTickets>
        }

        /**
         * Updates a support ticket.
         */
        public async updateTicket(params: RequestType<typeof api_proxy_tickets_updateTicket>): Promise<ResponseType<typeof api_proxy_tickets_updateTicket>> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/tickets/${encodeURIComponent(params.id)}`, {method: "PATCH", body: JSON.stringify(body)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_proxy_tickets_updateTicket>
        }
    }
}
